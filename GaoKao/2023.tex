...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/national_paper_a_science/q3_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=6.2cm]{GaoKao/images/2023/national_paper_a_science/q18_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/national_paper_a_liberal/q6_fig1.png}
\par}
        ...
        \item 曲线 $y=\dfrac{\mathrm{e}^x}{x+1}$ 在点 $\bigl(1,\frac{\mathrm{e}}{2}\bigr)$ 处的切线方程为
       
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
          \(\text{A. }y=\dfrac{\mathrm{e}}{4}x\)  & \(\text{B. }y=\dfrac{\mathrm{e}}{2}x\)  & \(\text{C. }y=\dfrac{\mathrm{e}}{4}x+\dfrac{\mathrm{e}}{4}\)  & \(\text{D. }y=\dfrac{\mathrm{e}}{2}x+\dfrac{3\mathrm{e}}{4}\)
        \end{tabular*}\par}
        ...
        \item 已知函数 $f(x)=\mathrm{e}^{-(x-1)^2}$．记 $a=f\bigl(\frac{\sqrt{2}}{2}\bigr)$，$b=f\bigl(\frac{\sqrt{3}}{2}\bigr)$，$c=f\bigl(\frac{\sqrt{6}}{2}\bigr)$，则
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=6.3cm]{GaoKao/images/2023/national_paper_a_liberal/q18_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=6.0cm]{GaoKao/images/2023/national_paper_b_science/q3_fig1.png}
\par}
        ...
        \item 已知 $f(x)=\dfrac{x\mathrm{e}^x}{\mathrm{e}^{ax}-1}$ 是偶函数，则 $a=$
...
\end{center}
        ...
        {\centering
\includegraphics[width=6.7cm]{GaoKao/images/2023/national_paper_b_science/q19_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=8.0cm]{GaoKao/images/2023/national_paper_b_liberal/q3_fig1.png}
\par}
...
\end{center}
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/national_paper_b_liberal/q19_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=4.5cm]{GaoKao/images/2023/new_gaokao_paper_1/q18_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \item 已知函数 $f(x)=a\mathrm{e}^x-\ln x$ 在区间 $(1,2)$ 单调递增，则 $a$ 的最小值为
       
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
          \(\text{A. }\mathrm{e}^2\)  & \(\text{B. }\mathrm{e}\)  & \(\text{C. }\mathrm{e}^{-1}\)  & \(\text{D. }\mathrm{e}^{-2}\)
        \end{tabular*}\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        {\centering
\includegraphics[width=3.3cm]{GaoKao/images/2023/new_gaokao_paper_2/q16_fig1.png}
\par}
    \end{enumerate}
\end{description}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/new_gaokao_paper_2/q19_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=5.3cm]{GaoKao/images/2023/new_gaokao_paper_2/q20_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/beijing/q9_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+15}
        ...
        {\centering
\includegraphics[width=7.7cm]{GaoKao/images/2023/beijing/q16_fig1.png}
\par}
...
\end{center}
        ...
        设函数 $f(x)=x-x^3\mathrm{e}^{ax+b}$，曲线 $y=f(x)$ 在点 $(1,f(1))$ 处的切线方程为 $y=-x+1$．
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=5.3cm]{GaoKao/images/2023/shanghai/q17_fig1.png}
\par}
        ...
        \begin{enumerate}[label=(\arabic*)]
            \item 若 $a_1=\mathrm{e}^2$，求 $a_2,a_3$；
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=6.2cm]{GaoKao/images/2023/tianjin/q4_fig1.png}
\par}

        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
          \(\text{A. }\dfrac{5(\mathrm{e}^x-\mathrm{e}^{-x})}{x^2+2}\)  & \(\text{B. }\dfrac{5\sin x}{x^2+1}\)  & \(\text{C. }\dfrac{5(\mathrm{e}^x+\mathrm{e}^{-x})}{x^2+2}\)  & \(\text{D. }\dfrac{5\cos x}{x^2+1}\)
        \end{tabular*}\par}
...
\par}
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2023/tianjin/q7_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+15}
        ...
        {\centering
\includegraphics[width=5.5cm]{GaoKao/images/2023/tianjin/q17_fig1.png}
\par}
