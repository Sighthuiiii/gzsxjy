...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
            \(\text{A. }y=a+bx\)  & \(\text{B. }y=a+bx^2\)  & \(\text{C. }y=a+b\e^x\)  & \(\text{D. }y=a+b\ln x\)
        \end{tabular*}\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \textsf{[插入图片：多面体三视图，正视图中标有$E$、$F$、$G$、$H$，俯视图中标有$M$、$N$]}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        \textsf{[插入图片：三棱柱$ABC$-$A_1B_1C_1$，标有$M$、$N$、$P$、$E$、$F$、$O$点]}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \textsf{[插入图片：钢琴键盘，标有$a_1$到$a_{12}$]}
        ...
        \textsf{[插入图片：程序框图，$a=2a+1$, $k=k+1$, 判断$a>10$]}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \item Logistic模型是常用数学模型之一, 可应用于流行病学领域. 有学者根据公布数据建立了某地区新冠肺炎累计确诊病例数$I(t)$ ($t$的单位: 天)的Logistic模型: $I(t)=\dfrac{K}{1+\e^{-0.23(t-53)}}$, 其中$K$为最大确诊病例数. 当$I(t^{*})=0.95K$时, 标志着已初步遏制疫情, 则$t^{*}$约为$(\ln 19\approx 3)$ (\qquad)
        ...
        \textsf{[插入图片：几何体的三视图，标有尺寸$2$、$\sqrt{2}$]}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        \textsf{[插入图片：长方体$ABCD$-$A_1B_1C_1D_1$，标有$E$、$F$点]}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        \item 设函数$f(x)=\dfrac{\e^{x}}{x+a}$. 若$f'(1)=\dfrac{\e}{4}$, 则$a=$ \rule[-0.3ex]{3em}{0.4pt}.
        \item 已知圆锥的底面半径为$1$, 母线长为$3$, 则该圆锥内半径最大的球的体积为 \rule[-0.3ex]{3em}{0.4pt}.
    \end{enumerate}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \end{tabular*}\par}        \item 基本再生数$R_{0}$与世代间隔$T$是新冠肺炎的流行病学基本参数．基本再生数指一个感染者传染的平均人数，世代间隔指相邻两代间传染所需的平均时间．在新冠肺炎疫情初始阶段，可以用指数模型：$I(t)=\e^{rt}$描述累计感染病例数$I(t)$随时间$t$（单位：天）的变化规律，指数增长率$r$与$R_{0},T$近似满足$R_{0}=1+rT$．有学者基于已有数据估计出$R_{0}=3.28$，$T=6$．据此，在新冠肺炎疫情初始阶段，累计感染病例数增加$1$倍需要的时间约为$(\ln 2\approx 0.69)$（\quad）
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+8}
        ...
        \textsf{[插入图片：正弦函数部分图象，与x轴交于$-\frac{\pi}{6}$和$\frac{2\pi}{3}$，过y轴上方]}
        \begin{enumerate}[label=\Alph*.]
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        \end{enumerate}        \item 已知函数$f(x)=a\e^{x-1}-\ln x+\ln a$．
        \begin{enumerate}[label=(\arabic*)]
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+8}
        ...
        \textsf{[插入图片：复工复产指数折线图，横轴为天数1-11]}
        \begin{enumerate}[label=\Alph*.]
        ...
        \textsf{[插入图片：正弦函数部分图象，与x轴交于$-\frac{\pi}{6}$和$\frac{2\pi}{3}$]}
        \begin{enumerate}[label=\Alph*.]
            \item $\sin\bigl(x+\frac{\pi}{3}\bigr)$
            \item $\sin\bigl(\frac{\pi}{3}-2x\bigr)$
            \item $\cos\bigl(2x+\frac{\pi}{6}\bigr)$
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        \end{enumerate}
        \item 已知函数$f(x)=a\e^{x-1}-\ln x+\ln a$．
        \begin{enumerate}[label=(\arabic*)]
            \item 当$a=\e$时，求曲线$y=f(x)$在点$(1,f(1))$处的切线与两坐标轴围成的三角形的面积；
            \item 若$f(x)\geqslant 1$，求$a$的取值范围．
        \end{enumerate}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \end{enumerate}
        \textsf{[插入图片：正方体$ABCD-A_1B_1C_1D_1$]}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \textsf{[插入图片：函数$y=\frac{4x}{x^{2}+1}$的四个图象选项A/B/C/D]}
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \textsf{[插入图片：函数$y=x\cos x+\sin x$在$[-\pi,\pi]$上的四个图象选项]}
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
            $\text{A. }$  & $\text{B. }$  & $\text{C. }$  & $\text{D. }$
        \end{tabular*}\par}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+17}
        ...
        \end{enumerate}
        \item 已知$1<a\leqslant 2$，函数$f(x)=\e^{x}-x-a$，其中$\e=2.71828\cdots$为自然对数的底数．
        \begin{enumerate}[label=(\arabic*)]
            ...
            \ding{173}$x_{0}f(\e^{x_{0}})\geqslant(\e-1)(a-1)a$．
        \end{enumerate}
    \end{enumerate}
\end{description}
\clearpage
