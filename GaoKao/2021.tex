...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2021/national_paper_a_science/q2_fig1.png}
\par}
        ...
        {\centering
            ...
            \(\text{A. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/national_paper_a_science/q6_optA.png}\)  &  \(\text{B. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/national_paper_a_science/q6_optB.png}\)  &  \(\text{C. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/national_paper_a_science/q6_optC.png}\)  &  \(\text{D. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/national_paper_a_science/q6_optD.png}\)
        \end{tabular*}
        \par}
        ...
        {\centering
\includegraphics[width=5.3cm]{GaoKao/images/2021/national_paper_a_science/q8_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2021/national_paper_a_science/q16_fig1.png}
\par}
    \end{enumerate}
\end{description}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=4.3cm]{GaoKao/images/2021/national_paper_a_science/q19_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        \item 已知命题 $p:\exists x\in\mathbb{R},\sin x<1$；命题 $q:\forall x\in\mathbb{R},\mathrm{e}^{|x|}\geqslant1$，则下列命题中为真命题的是
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2021/national_paper_B_liberal/q16_fig1.png}
\par}
    \end{enumerate}
\end{description}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=6.5cm]{GaoKao/images/2021/national_paper_B_liberal/q18_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=0.65\linewidth]{GaoKao/images/2021/national_paper_a_liberal/q2_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=5.2cm]{GaoKao/images/2021/national_paper_B_science/q9_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        {\centering
\includegraphics[width=12.0cm]{GaoKao/images/2021/national_paper_B_science/q16_fig1.png}
\par}
    \end{enumerate}
\end{description}
...
\par}
        ...
        已知函数 $f(x)=(x-1)\mathrm{e}^x-ax^2+b$，曲线 $y=f(x)$ 在点 $(1,f(1))$ 处的切线方程为 $y=2\mathrm{e} x-\mathrm{e}$．
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=4.5cm]{GaoKao/images/2021/national_paper_a_liberal/q19_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering\begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}llll@{}}
          \(\text{A. }\mathrm{e}^{b}<a\)  & \(\text{B. }\mathrm{e}^{a}<b\)  & \(\text{C. }0<a<\mathrm{e}^{b}\)  & \(\text{D. }0<b<\mathrm{e}^{a}\)
        \end{tabular*}\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+8}
        ...
        \begin{enumerate}[label=\Alph*.]
            \item \includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/new_gaokao_paper_2/q10_optA.png}
            \item \includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/new_gaokao_paper_2/q10_optB.png}
            \item \includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/new_gaokao_paper_2/q10_optC.png}
            \item \includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/new_gaokao_paper_2/q10_optD.png}
        \end{enumerate}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+15}
        \item 已知函数 $f(x)=|\mathrm{e}^{x}-1|$，$x_{1}<0$，$x_{2}>0$，函数 $f(x)$ 的图象在点 $A(x_{1},f(x_{1}))$ 和点 $B(x_{2},f(x_{2}))$ 处的两条切线互相垂直，且分别交 $y$ 轴于 $M,N$ 两点，则 $\frac{|AM|}{|BN|}$ 的取值范围是 \rule[-0.3ex]{3em}{0.4pt}．
        ...
        \begin{enumerate}[label=(\arabic*)]
            ...
            \ding{172} $\frac{1}{2}<a\leqslant\frac{\mathrm{e}^{2}}{2}$，$b>2a$；
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=5.4cm]{GaoKao/images/2021/beijing/q4_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=4.9cm]{GaoKao/images/2021/beijing/q8_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+15}
        ...
        {\centering
\includegraphics[width=5.8cm]{GaoKao/images/2021/beijing/q17_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+12}
        ...
        {\centering
            \begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}cccc@{}}
            \(\text{A. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/shanghai/q14_fig1.png}\)  &  \(\text{B. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/shanghai/q14_fig2.png}\)  &  \(\text{C. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/shanghai/q14_fig3.png}\)  &  \(\text{D. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/shanghai/q14_fig4.png}\)
        \end{tabular*}
        \par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+16}
        ...
        {\centering
\includegraphics[width=3.8cm]{GaoKao/images/2021/shanghai/q17_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
            \begin{tabular*}{\linewidth}{@{}@{\extracolsep{\fill}}cccc@{}}
            \(\text{A. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/tianjin/q3_optA.png}\)  &  \(\text{B. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/tianjin/q3_optB.png}\)  &  \(\text{C. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/tianjin/q3_optC.png}\)  &  \(\text{D. }\includegraphics[width=0.15\paperwidth]{GaoKao/images/2021/tianjin/q3_optD.png}\)
        \end{tabular*}
        \par}
        ...
        {\centering
\includegraphics[width=9.7cm]{GaoKao/images/2021/tianjin/q4_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+15}
        ...
        {\centering
\includegraphics[width=5.6cm]{GaoKao/images/2021/tianjin/q17_fig1.png}
\par}
...
\begin{description}
    ...
    \begin{enumerate}[leftmargin=5pt]
        ...
        {\centering
\includegraphics[width=6.4cm]{GaoKao/images/2021/zhejiang/q4_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=5.7cm]{GaoKao/images/2021/zhejiang/q6_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=6.0cm]{GaoKao/images/2021/zhejiang/q7_fig1.png}
\par}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+10}
        ...
        {\centering
\includegraphics[width=4.8cm]{GaoKao/images/2021/zhejiang/q11_fig1.png}
\par}
    ...
    \begin{enumerate}[leftmargin=5pt]
      \addtocounter{enumi}{+17}
        ...
        {\centering
\includegraphics[width=7.6cm]{GaoKao/images/2021/zhejiang/q19_fig1.png}
\par}
        ...
        {\centering
\includegraphics[width=7.7cm]{GaoKao/images/2021/zhejiang/q21_fig1.png}
\par}
        ...
        设 $a,b$ 为实数，且 $a>1$，函数 $f(x)=a^{x}-bx+\mathrm{e}^{2}$（$x\in\mathbb{R}$）．

        \begin{enumerate}[label=(\arabic*)]
            \item 求函数 $f(x)$ 的单调区间；
            \item 若对任意 $b>2\mathrm{e}^{2}$，函数 $f(x)$ 有两个不同的零点，求 $a$ 的取值范围；
            \item 当 $a=\mathrm{e}$ 时，证明：对任意 $b>\mathrm{e}^{4}$，函数 $f(x)$ 有两个不同的零点 $x_{1},x_{2}$，满足 $x_{2}>\frac{b\ln b}{2\mathrm{e}^{2}}x_{1}+\frac{\mathrm{e}^{2}}{b}$．
        \end{enumerate}
    \end{enumerate}
\end{description}
\clearpage
